...
- the first card does not show current-user identity text and ends with one compact external repo action that links to `https://github.com/justyn-clark/space-agent`
